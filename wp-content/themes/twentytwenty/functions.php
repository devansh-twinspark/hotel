...
$labels = array(
'name' => _x('Testimonial', 'plural'),  //post_type ll always  be in plural 
...
$args = array(
  ...
  'public' => true,
  'has_archive' => false,
  'rewrite' => array('slug' => 'autocomplete_users_for_site_admins'),
 );
$supports = array(
'title', // post title
'editor', // post content
...
function show_your_fields_meta_box($post_id) {
    	global $post;
    	// print_r($post_id);die();
    		$meta = get_post_meta( $post_id->ID, 'testimonial_name', true ); 
    		$meta_a = get_post_meta( $post_id->ID, 'testimonial_designation', true );
    		// print_r($meta);die('ss');
    		?>
    		<label><b>Name</b></label>
    	<input type="text" name="testimonial_name" value="<?php echo $meta;?>">
    	<label><b>Designation</b></label>
    	<input type="text" name="testimonial_designation" value="<?php echo $meta_a;?>">
...
function save_your_fields_meta( $post_id ) {
    	// verify nonce
    	/*if ( !wp_verify_nonce( $_POST['testimonial_name'], basename(__FILE__) ) ) {
    		return $post_id;
    	}*/
    	// check autosave
    	...
    	//$old = get_post_meta( $post_id, 'testimonial_name', true );
    	$new = $_POST['testimonial_name'];
    	$new_a= $_POST['testimonial_designation'];
	/*echo "<pre>";
	print_r($new);
	echo "</pre>";
	die('ss');*/
    	...
    	// if ( $new && $new !== $old ) {
    		update_post_meta( $post_id, 'testimonial_name', $new );
    		update_post_meta( $post_id, 'testimonial_designation', $new_a );
    	//}
    	 /*elseif ( '' === $new && $old ) {
...
function add_my_post_types_to_query( $query ) {
    if ( is_home() && $query->is_main_query() )
        $query->set( 'post_type', array( 'post', 'testimonial' ) );
    return $query;
}
